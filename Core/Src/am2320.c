...
static uint8_t AM2320_Verify_Data(uint64_t data){
...
uint8_t AM2320_Get_Data(uint16_t *temp,uint16_t *humi){

	uint64_t data = AM2320_ReadData();
	if(data<0xff){
		return (uint8_t)data; //return error
	}
	if (AM2320_Verify_Data(data)) return DHT_ERR_DATA_CHKSUM_FAILED; //数据位校验
...
void AM2320_THMsg(uint16_t Temp, uint16_t Humi, char THMsg[30]){
